...
if __name__ == '__main__':
    ...
    # 给出图片文件夹和检测框文件夹所在的位置
    image_dir = 'ultralytics/yolo/v8/detect/VOCdevkit/VOCdevkit/VOC2007/JPEGImages/'
    annotation_dir = 'ultralytics/yolo/v8/detect/VOCdevkit/VOCdevkit/VOC2007/Annotations/'
 
    image_list = []  # 存放每张图像和该图像对应的检测框坐标信息
    list = ('IP000000010','IP000000002','IP000000003','IP000000008')
    # 读取4张图像及其检测框信息
    for i in list:
        ...
        annotation_path = annotation_dir + str(i) + '.xml'
